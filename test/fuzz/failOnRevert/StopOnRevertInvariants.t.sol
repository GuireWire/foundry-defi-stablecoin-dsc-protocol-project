...
contract StopOnRevertInvariants is StdInvariant, Test {
    ...
    //invariant tries to break the assert(wethValue + wbtcValue >= totalSupply)
    function invariant_protocolMustHaveMoreValueThatTotalSupplyDollars() public view {
        // get the value of all collateral on protocol & compare it to all of the debt (DSC)
        ...
        //assert collateral >= totalSupply
        assert(wethValue + wbtcValue >= totalSupply);
    }

    //put getter functions in below so so they don't revert
