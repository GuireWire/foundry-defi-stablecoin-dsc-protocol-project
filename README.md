...
This is a section of the Cyfrin Foundry Solidity Course. Specifically Course 4 Section 3.
...
1. Relative Stability = Anchored/Pegged - > USD
   1. we can do this with Chainlink Price feed
   2. Set a function to exchange ETH & BTC -> $$$ (their dollar equivalent)
2. Stability Mechanism (Minting) = Algorithmic (Decentralized)
   1. People can only mint stablecoin with enough collateral (coded directly in protocol)
3. Collateral Type = Exogenous (Crypto as Collateral)
   1. wETH (wrappedETH - the ERC20 version of ETH)
   2. wBTC (wrappedBTC - the ERC20 version of BTC)
   3. we will only allow these 2 types of cryptos to be deposited
...
- [Foundry DeFi Stablecoin](#foundry-defi-stablecoin)
  - [Contracts:](#contracts)
  - [Stablecoin Properties](#stablecoin-properties)
- [About](#about)
